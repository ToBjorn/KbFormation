...
defmodule MyFSM do
  ...
  deftrans init({:process_payment, [validated]}, order) do
    {:next_state, validated && :verified || :not_verified, order}
  end
  ...
  deftrans verified({:verfication, []}, order) do
    {:next_state, :finished, order}
  end
end
